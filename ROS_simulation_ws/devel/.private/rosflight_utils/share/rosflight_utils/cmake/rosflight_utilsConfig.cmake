...
if("TRUE" STREQUAL "TRUE")
  set(rosflight_utils_SOURCE_PREFIX /home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/src/rosflight/rosflight_utils)
  set(rosflight_utils_DEVEL_PREFIX /home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/devel/.private/rosflight_utils)
  ...
  set(rosflight_utils_INSTALL_PREFIX /home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/install)
...
if(NOT "/home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/src/rosflight/rosflight_utils/include " STREQUAL " ")
  set(rosflight_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/src/rosflight/rosflight_utils/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosflight_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/src/rosflight/rosflight_utils/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/devel/.private/rosflight_utils/lib;/home/aghosh/Remote-Controlled-Airplane/ROS_simulation_ws/devel/lib;/opt/ros/melodic/lib)
