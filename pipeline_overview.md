...
The actuall alitude we receive from the altimeter sensor is in the form of a signed 16-bit integer. So the minimum and maximum altitudes that we can get is −32,768 to 32,767. However in order to send this data back over the radio we would need to split this 16-bit integer into 2 8-bit integers.
